...
public class BookingStep3Fragment extends Fragment {
    ...
    void confirmeApointement(){
        ...
        apointementInformation.setChemin("Lawyer/"+Common.CurreentDoctor+"/"+Common.simpleFormat.format(Common.currentDate.getTime())+"/"+String.valueOf(Common.currentTimeSlot));
        ...
        bookingDate.set(apointementInformation)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                FirebaseFirestore.getInstance().collection("Lawyer").document(Common.CurreentDoctor)
