...
public class EditProfileDoctorActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pStorageRef = FirebaseStorage.getInstance().getReference("LawyerProfile");
        pDatabaseRef = FirebaseDatabase.getInstance().getReference("LawyerProfile");
        ...
        pathReference = storageRef.child("LawyerProfile/" + userPhotoPath); //Doctor photo in database
    ...
    private void updateDoctorInfos(String name, String address, String phone) {
        DocumentReference documentReference = doctorRef.collection("Lawyer").document("" + doctorID + "");
