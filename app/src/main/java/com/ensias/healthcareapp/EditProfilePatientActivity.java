...
public class EditProfilePatientActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pStorageRef = FirebaseStorage.getInstance().getReference("ClientProfile");
        pDatabaseRef = FirebaseDatabase.getInstance().getReference("ClientProfile");
        ...
        pathReference = storageRef.child("ClientProfile/" + userPhotoPath); //Doctor photo in database
    ...
    private void updateDoctorInfos(String name, String address, String phone) {
        DocumentReference documentReference = doctorRef.collection("Client").document("" + doctorID + "");
