...
public class ConsultationFragmentPage extends Fragment {
    ...
    private void setUpRecyclerView() {
        ...
        String email_id = getActivity().getIntent().getExtras().getString("client_email");
        FicheRef = db.collection("Client").document(email_id).collection("MyMedicalFolder");
        Query query = FicheRef.whereEqualTo("type", "Online Consultation");
